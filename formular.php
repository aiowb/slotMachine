<html>
<head>
	<link rel="stylesheet" type="text/css" href="_css/form-style.css" />
</head>
<body>
	<div class="cms_header" style="width:400px">Gewinn wahrscheinlichkeit in %</div>
	<div class="form-group">
	<form class="cms_formular cms_content_bg" style="width:400px" name="myform" action="formular.php" method="post">
...
<div class="cms_header" style="width:400px">
